...
class AiPredicationScreen extends StatefulWidget {
  const AiPredicationScreen({super.key});

  @override
  State<AiPredicationScreen> createState() => _AiPredicationScreenState();
}

class _AiPredicationScreenState extends State<AiPredicationScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  '1- how much do you want Your daily consumption',
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Insert value (KW)',
                    hintStyle:
                        TextStyle(color: Color.fromARGB(255, 197, 194, 194)),
                  ),
                ),
              ),
              SizedBox(height: 16.h),
              Padding(
                ...
                child: Text(
                  '2- Specify the consumption in (KW) according to time of the day',
                  style: TextStyle(color: Colors.grey, fontSize: 14.sp),
                ),
              ),
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: () {
          ...
          print('Question: ${_dailyConsumptionController.text}');
        },
